...
<section class="py-5">
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            @empty($p->foto)
            <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="{{ url('admin/img/nofoto.jpg' )}}" alt="..." /></div>
            @else
            <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="{{ asset('admin/img/'.$p->foto )}}" alt="..." /></div>
            @endempty
            <div class="col-md-6">
                <div class="small mb-1">Kode : {{ $p->kode }}</div>
            ...
            <div class="form-group row">
                    <a href="{{ url('admin/produk') }}" class="btn btn-primary">
